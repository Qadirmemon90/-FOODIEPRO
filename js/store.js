...
// --- 2. LOAD PRODUCTS FROM FIRESTORE (Dark Mode Ready Cards) ---
function fetchProducts() {
    ...
    onSnapshot(q, (snapshot) => {
        ...
        if (snapshot.empty) {
            productList.innerHTML = `<p class="col-span-full text-center text-gray-400">Koi product nahi mili.</p>`;
            return;
        }
        ...
        snapshot.forEach((docSnap) => {
            ...
            // Card design with dark mode classes
            productList.innerHTML += `
                <div class="bg-white dark:bg-slate-800 rounded-[2.5rem] p-5 shadow-sm border border-gray-100 dark:border-slate-700 card-hover transition-all duration-300 group">
                    ...
                    <div class="flex justify-between items-center mt-4">
                        ...
                        <button onclick="addToCart('${id}', '${prod.name}', ${prod.price}, '${imgPath}')" 
